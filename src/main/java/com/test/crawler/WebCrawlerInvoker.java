...
public class WebCrawlerInvoker {
    ...
    static final Logger logger = LoggerFactory.getLogger(WebCrawlerInvoker.class);

    public static void main(String args[]) {

        WebCrawlerInvoker application = new WebCrawlerInvoker(args);
        application.run();

    }

    public WebCrawlerInvoker(String args[]) {
    ...
    public void run() {
        try {
            ...
            WebCrawler crawler = getCrawler();

            WebCrawlerResponse response = crawler.crawl(url);

            ResponseTransformerToXML transformer = new ResponseTransformerToXML();
    ...
    private WebCrawler getCrawler() {
        WebCrawler crawler = new WebCrawler(tempDir);
